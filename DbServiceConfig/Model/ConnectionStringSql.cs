...
{
    public class ConnectionStringSql : INotifyPropertyChanged
    {
        ...
        public ConnectionStringSql() { }


        public ConnectionStringSql(string connectionString)
        {
            _builder.ConnectionString = connectionString;
        }

        public static implicit operator string(ConnectionStringSql connectionString)
        {
        ...
        /// <returns></returns>
        public ConnectionStringSql WithDatabase(string databaseName)
        {
            return new ConnectionStringSql
            {
                Server = Server,
        ...
        public string AttachDBFilename
        {
            get
            {
                return _builder.AttachDBFilename;
            }
            set
            {
                if (_builder.AttachDBFilename == value) return;
                _builder.AttachDBFilename = value;
